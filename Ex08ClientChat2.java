...
public class Ex08ClientChat2 extends JFrame implements Runnable, ActionListener{
	JTextArea area;
	String nickName;
...
//		this.setDefaultCloseOperation(EXIT_ON_CLOSE);
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					try {
						...
						//창 제목을 닉네임으로 변경
						Ex08ClientChat2.this.setTitle(tfNickName.getText()+"님의 채팅창");
						...
						//run메서드 호출
						Thread th = new Thread(Ex08ClientChat2.this); //익명내부라서 외부클래스의 this를 보내야한다
						th.start();
	...
	public static void main(String[] args) {
		Ex08ClientChat2 ex = new Ex08ClientChat2();
	}
